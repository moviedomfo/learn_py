...
from app.tests.utils import create_bid, create_auction
from app.use_cases.exceptions import AuctionNotFoundError
from app.use_cases.submit_bid_use_case import SubmitBidUseCase

@pytest.fixture
def auctions_repository() -> IAuctionRepository:
    return InMemoryAuctionRepository()


@pytest.fixture
def submit_bid_use_case(auctions_repository: IAuctionRepository) -> SubmitBidUseCase:
